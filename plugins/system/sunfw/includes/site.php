		...
		else
		{
			...
			else
			{
				...
				if (strpos($tmpBackLink, 'joomlashine'))
				{
					...
					$backLink = '<div style="text-align:center;background: #ffffff;max-width: 400px;margin: 0 auto;border-radius: 2px;margin-top: 2px;opacity: 0.7;">© Copyright '.date('Y').'. Bản quyền thuộc về <a href="http://thaithiennam.vn">THAITHIENNAM.VN</a></div>';
				}				
			}
		}
