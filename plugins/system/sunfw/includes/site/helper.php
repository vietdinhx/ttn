...
class SunFwSiteHelper
{
	...
	/**
	 * Get path to cache directory for storing compression assets.
	 *
	 * @param   SunFwSite  $renderer  SunFw renderer object.
	 *
	 * @return  mixed  Whether path to the cache directory or null if not specified.
	 */
	public static function getCacheDirectory($renderer = null)
	{
		return self::getInstance($renderer)->_getCacheDirectory();
	}
	...
	/**
	 * Prepare and return path to the directory for storing compressed assets.
	 *
	 * @return  mixed  Whether path to the cache directory or null if not specified.
	 */
	...
	{
		// Get system data.
		$systemData = isset($this->renderer->system_data) ? $this->renderer->system_data : array();

		// Verify cache directory.
		if (empty($systemData['cacheDirectory']))
		{
			return null;
		}
