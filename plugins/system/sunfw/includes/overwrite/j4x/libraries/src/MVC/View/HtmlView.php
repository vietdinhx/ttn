...
class HtmlView extends AbstractView
{
	...
	public function __construct($config = array())
	{
		...
		$this->sunfw_template = PlgSystemSunFw::$template ? PlgSystemSunFw::$template->template : \JFactory::getApplication()->getTemplate();
	...
	public function loadTemplate($tpl = null)
	{
		...
		$template = PlgSystemSunFw::$template ? PlgSystemSunFw::$template->template : \JFactory::getApplication()->getTemplate();
		...
		switch (strtolower($type))
		{
			case 'template':
				...
				if (isset($app))
				{
					...
					$fallback = JPATH_THEMES . '/' . (PlgSystemSunFw::$template ? PlgSystemSunFw::$template->template : $app->getTemplate()) . '/html/' . $component . '/' . $this->getName();
