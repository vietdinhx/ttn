	...
	public function getAction($return = false)
	{
		...
		$data = array(
			...
			'textMapping' => array(
			    ...
			    'enable-commenting-popover-content' => JText::_('SUNFW_ENABLE_COMMENTING_POPOVER_CONTENT'),
			    'commenting-type-popover-content' => JText::_('SUNFW_COMMENTING_TYPE_POPOVER_CONTENT'),
			    'commenting-disqus-subdomain-popover-content' => JText::_('SUNFW_COMMENTING_DISQUS_SUBDOMAIN_POPOVER_CONTENT'),
			    'commenting-facebook-app-id-popover-content' => JText::_('SUNFW_COMMENTING_FACEBOOK_APP_ID_POPOVER_CONTENT'),
			    'commenting-facebook-num-posts-popover-content' => JText::_('SUNFW_COMMENTING_FACEBOOK_NUM_POSTS_POPOVER_CONTENT'),
			    'commenting-intensedebate-site-account-popover-content' => JText::_('SUNFW_COMMENTING_INTENSEDEBATE_SITE_ACCOUNT_POPOVER_CONTENT'),
			    'commenting-google-comments-box-width-popover-content' => JText::_('SUNFW_COMMENTING_GOOGLE_COMMENTS_BOX_WIDTH_POPOVER_CONTENT'),
			    'commenting-show-text-popover-content' => JText::_('SUNFW_COMMENTING_SHOW_TEXT_POPOVER_CONTENT'),
			    'commenting-show-counter-popover-content' => JText::_('SUNFW_COMMENTING_SHOW_COUNTER_POPOVER_CONTENT'),
			    'commenting-category-popover-content' => JText::_('SUNFW_COMMENTING_CATEGORY_POPOVER_CONTENT')
			)
		);
