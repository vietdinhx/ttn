...
$setter = method_exists($editor, 'setContent') ? $editor->setContent('editor', '%CONTENT%') : null;
	...
	<script type="text/javascript">
		window.addEventListener('load', function() {
			...
			window.sunFwEditorSetContent = function(content) {
				...
				?>
				for (var e in Joomla.editors.instances) {
					Joomla.editors.instances[e].setValue(content);
				}
				<?php endif; ?>
			};
		});
