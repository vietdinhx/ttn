...
margin-left: 13px;">
<div class="blank">
    <button class='btn btn-large btn-success' id='huge-it-insert-video-button' onClick="alert('Add Video Slide feature is disabled in free version. If you need this functionality, you need to buy the commercial versionSorry, Add Video feature is disabled in free version, please purchase the commercial version to use it.');window.parent.location.reload();" style=" margin-left: 10px;" >Insert Video Slide</button>
</div>
</div>
