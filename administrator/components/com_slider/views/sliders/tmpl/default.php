...
<div id="h-main-container" class="span10 h-toggle-main">
 <div class="">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_slider'); ?>" method="post" name="adminForm" id="adminForm" style="margin-top:10px">
    <table class="wp-list-table widefat fixed pages" style="width:100%;">
        ...
        <th style="text-align: left;"><?php echo JText::_('Shortecodes'); ?></th>
