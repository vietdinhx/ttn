...
<div id="h-main-container" class="span10 h-toggle-main">
 ...
 <form action="<?php echo JRoute::_('index.php?option=com_slider'); ?>" id="application-form" method="post" name="adminForm" class="form-validate" style="margin-top:10px">
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slider/images/lightbox.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slider/images/lightbox.png'; ?>"></a>
                </div>
            </div>
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slider/images/gallery.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slider/images/gallery.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
      ...
      <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slider/images/catalog.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slider/images/catalog.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slider/images/map.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slider/images/map.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slider/images/portfolio.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slider/images/portfolio.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slider/images/videogallery.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slider/images/videogallery.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slider/images/slideshow.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slider/images/slideshow.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
